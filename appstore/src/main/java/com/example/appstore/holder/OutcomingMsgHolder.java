...
public class OutcomingMsgHolder extends BaseHolder<ChatMessage> {
    ...
    public View initHolderView() {
        View view = View.inflate(UIUtils.getContext(), R.layout.item_to_msg, null);
        tv_date = (TextView) view.findViewById(R.id.tv_to_time_chat);
        tv_msg = (TextView) view.findViewById(R.id.tv_to_msg_chat);
        return view;
    }
