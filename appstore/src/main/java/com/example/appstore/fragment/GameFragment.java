...
public class GameFragment extends BaseFragment {
    ...
    public LoadedResult initData() {
        ...
        //使用线程池管理
        ThreadPoolFactory.getNormalThreadPool().executeTask(new LoadGameThread());
    ...
    public View initSuccessView() {
        ListView listView = new ListViewFactory() {
            ...
            public List<AppInfo> loadMore() {
                return protocol.queryByType("game", mDataList.size());
            }
    ...
    class LoadGameThread implements Runnable {
        @Override
        public void run() {
            mDataList = protocol.queryByType("game", 0);
        }
    }
